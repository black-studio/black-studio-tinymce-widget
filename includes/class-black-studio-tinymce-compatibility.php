	...
	final class Black_Studio_TinyMCE_Compatibility {
		...
		public function load_plugins() {
			...
			if ( ! empty( $load_compatibility_plugins ) ) {
				include_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-black-studio-tinymce-compatibility-plugins.php';
		...
		public function load_wordpress() {
			if ( version_compare( get_bloginfo( 'version' ), '3.9', '<' ) ) {
				include_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-black-studio-tinymce-compatibility-wordpress.php';
